/*
 * InPatientForm Component - Hospital Management System
 * 
        ...
        <form onSubmit={handleSubmit} className={styles.patientForm}>
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formGrid}>
              <div className={styles.formGroup}>
                <label className={styles.formLabel}>
                  Discharge Date
                  <span className={styles.autoGeneratedNote}> (Auto-set on discharge)</span>
                </label>
                <input
                  type="datetime-local"
                  name="discharge_date"
                  ...
                  disabled
                  className={`${styles.formInput} ${styles.disabledInput}`}
                  placeholder="Set automatically when patient is discharged"
                />
                <small className={styles.helpText}>
                  Discharge date is automatically set when the patient is discharged through the system.
                </small>
              </div>
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                <label className={styles.formLabel}>Respiratory Rate (per min)</label>
                <input
                  type="number"
            ...
            <div className={styles.formGrid}>
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  rows="4"
                />
                <SanitizedFieldMessage fieldName="physical_examination" />
              </div>
              <div className={styles.formGroup}>
                ...
                />
                <SanitizedFieldMessage fieldName="main_complaint" />
            ...
            <div className={styles.formGrid}>
              <div className={styles.formGroup}>
                ...
                />
                <SanitizedFieldMessage fieldName="present_illness" />
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  className={styles.formTextarea}
                  rows="4"
                  disabled={isFieldRestricted('clinical_findings')}
                  placeholder={isFieldRestricted('clinical_findings') ? 'This field is restricted for your role' : ''}
                />
                <SanitizedFieldMessage fieldName="clinical_findings" />
                <RestrictedFieldMessage fieldName="clinical_findings" />
              </div>
            </div>
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                ...
                />
                <SanitizedFieldMessage fieldName="treatment" />
            ...
            <div className={styles.formGrid}>
              <div className={styles.formGroup}>
                ...
                />
                <SanitizedFieldMessage fieldName="diagnosis" />
            ...
            <div className={styles.formGrid}>
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  className={styles.formTextarea}
                  rows="3"
                  disabled={isFieldRestricted('principal_diagnosis')}
                  placeholder={isFieldRestricted('principal_diagnosis') ? 'This field is restricted for your role' : ''}
                />
                <RestrictedFieldMessage fieldName="principal_diagnosis" />
              </div>
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  className={styles.formTextarea}
                  rows="3"
                  disabled={isFieldRestricted('other_diagnosis')}
                  placeholder={isFieldRestricted('other_diagnosis') ? 'This field is restricted for your role' : ''}
                />
                <RestrictedFieldMessage fieldName="other_diagnosis" />
              </div>
            </div>
