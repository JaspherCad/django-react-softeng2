...
class LaboratoryResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'code', 'patient', 'patientInfo','test_type', 'result_summary', 'date_performed', 'performed_by', 'attachments', 'file_groups', 'performed_by_info']
...
class UserImageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserImage
        fields = ['id', 'user', 'file', 'file_url', 'description', 'uploaded_by', 'uploaded_at']
        extra_kwargs = {
            'user': {'read_only': True},
            'file': {'required': True},
